...
Open a Web browser and enter the address and port number of the gateway running GridBeat to enter the management console dashboard. The default port number is 7000.

Access format, http://x.x.x.x:7000 x.x.x.x represents the address of the gateway where GridBeat is installed.
